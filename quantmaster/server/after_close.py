...
# Snapshot IDs are generated by after_close/service.py as
# "ac_" + a lowercase hex digest fragment.  Register a real Starlette
# converter so invalid literal paths do not match this route.
_SNAPSHOT_ID_PATTERN = r"ac_[a-f0-9]+"


class _SnapshotIdConvertor(StringConvertor):
    regex = _SNAPSHOT_ID_PATTERN


register_url_convertor("snapshot_id", _SnapshotIdConvertor())
...
@router.get("/snapshots/{snapshot_id:snapshot_id}")
...
@router.get("/export/{snapshot_id:snapshot_id}")
def export_snapshot(
