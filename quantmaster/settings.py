    ...
    if kind in {"llm-models", "llm-web-search"}:
        ...
        subject = {
            ...
            "data": {
                ...
                "free_stockdb_online_enabled": document.data.free_stockdb_online_enabled,
                "free_stockdb_online_url": document.data.free_stockdb_online_url,
                "free_stockdb_online_timeout": document.data.free_stockdb_online_timeout,
