...
def _official_fixture_now() -> float:
    """Return a fixed clock close to the 2026-08-09 official fixture dates."""
    return pd.Timestamp("2026-08-10T00:00:00+08:00").timestamp()


def _freeze_official_provider_clock(monkeypatch) -> None:
    monkeypatch.setattr("quantmaster.ai.news_providers.time.time", _official_fixture_now)
